...
DATASET_YAML = os.path.abspath(
    os.path.join(os.path.dirname(__file__),
                 "../../data/xhs_dataset/augmented_yolo_v4/dataset.yaml")
)
...
# ============================================================
MODEL = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../models/xhs_ui_yolo_v3/best.pt"))
DEVICE = get_device()
...
def train():
    print(f"\n{'=' * 60}")
    print(f"XHS UI Detection - YOLO Training V4")
    print(f"{'=' * 60}")
    ...
    best_path = os.path.join(PROJECT_DIR, "xhs_ui_detect_v4", "weights", "best.pt")
    print(f"\n{'=' * 60}")
